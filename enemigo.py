...
from proyectil import COLOR_BALAS_BLANCAS
...
class Enemigo(Tanque):
    ...
    #IMAGENES:
        self.imagen_arriba = pygame.image.load('Imagenes/Enemigo_arriba.png')
        self.imagen_abajo = pygame.image.load('Imagenes/Enemigo_abajo.png')
        self.imagen_derecha = pygame.image.load('Imagenes/Enemigo_derecha.png')
        self.imagen_izquierda = pygame.image.load('Imagenes/Enemigo_izquierda.png')
    ...
    def generador_de_proyectiles(self):
        if len(self.proyectiles) < self.maximo_proyectiles_simultaneos:
            self.proyectiles = Proyectil(self, COLOR_BALAS_BLANCAS)